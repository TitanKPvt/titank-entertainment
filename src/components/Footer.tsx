        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => handleNavigation('#home')} className="text-gray-400 hover:text-red-400 transition-colors">
                  Home
                </button>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => handleNavigation('#services')} className="text-gray-400 hover:text-red-400 transition-colors">
                  Services
                </button>
              </li>
              <li>
                <button onClick={() => handleNavigation('#achievements')} className="text-gray-400 hover:text-red-400 transition-colors">
                  Achievements
                </button>
              </li>
              <li>
                <button onClick={() => handleNavigation('#contact')} className="text-gray-400 hover:text-red-400 transition-colors">
                  Contact
                </button>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              {/* Call only */}
              <p>
                <a href="tel:9324903399" className="hover:text-red-400 transition-colors">
                  +91 93249 03399
                </a>
              </p>
